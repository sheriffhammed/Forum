...
const onSubmit = (data, e) => {
    e.preventDefault();
    const userDetails = allUsers.users.filter(user => user.email === 's.olaleke@yahoo.com')
    console.log("User Record :", userDetails[0])
    console.log("Email Data Value :", data.email)
    ...
    <ThemeProvider theme={defaultTheme}>
      <Container component="main" maxWidth="xs">
        ...
        >
          ...
          <Typography variant="h4" component="div" sx={{ flexGrow: 1 }}  color="red">{errorMessage} </Typography>
          {showSuccess ?
          <div>
            <Typography variant="h4" component="div" sx={{ flexGrow: 1 }}>Password Changed Succesful!!! </Typography>
